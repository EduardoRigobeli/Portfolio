...
export default function Home() {
  return (
    <div className="pl-105 pt-20">
      <h1 className={`${firaCode.className} text-white font-medium text-8xl cursor-default whitespace-nowrap overflow-hidden w-[9.6ch] border-r-[20px] animate-t-b`}>BEM VINDO</h1>
